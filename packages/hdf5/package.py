...
class Hdf5(AutotoolsPackage):
    ...
    version('daos-develop', branch='feature/daos_vol_support')
    ...
    depends_on('autoconf', type='build', when='@daos-develop')
    depends_on('automake', type='build', when='@daos-develop')
    depends_on('libtool',  type='build', when='@daos-develop')
    depends_on('m4',       type='build', when='@daos-develop')
    depends_on('pkgconfig',type='build', when='@daos-develop')
    ...
    def configure_args(self):
        ...
        if self.spec.satisfies('@1.10:') or self.spec.satisfies('@daos-develop'):
